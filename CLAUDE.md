...
python main.py --cross_fusion moe --moe_num_experts 4 --moe_hidden_dim 64

# Key hyperparameters
python main.py --name D1 --seed 0 --spatial_k 9 --adj_k 20 --lambda1 1 --lambda2 0.1 --lr 1e-3 --pretrain_epoch 10000 --train_epoch 2500
```
