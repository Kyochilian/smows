...
Author：polaris
Data：2024年06月25日
SpaFusion Data Processing (DO NOT MODIFY core logic)
"""
...
def load_data(adata_omics1, view1, adata_omics2, view2, n_neighbors=9, k=20):
    if view1 == "RNA":
...
def construct_graph_by_feature(adata_omics1, adata_omics2, k=20, mode="connectivity", metric="euclidean",
                               include_self=True):
    """Constructing feature neighbor graph according to express profiles"""
